...
This implementation guide is expected to be used in conjunction with other implementation guides (Profiles) that provide access to Patient specific data such as [Mobile Health Document Sharing (MHDS)](https://profiles.ihe.net/ITI/MHDS/index.html) or the [PCC](https://profiles.ihe.net/PCC/index.html) Query for Existing Data for Mobile (QEDm). These other implementation guides would have their [appropriate actors grouped such as is shown in Figure 1:53.1-1](volume-1.html#531-pcf-actors-transactions-and-content-modules) as "Grouped Client" and "Grouped Server".
