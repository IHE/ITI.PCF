This section corresponds to transaction [ITI-110] of the IHE Technical Framework. Transaction [ITI-110] is used by the Consent Recorder, Consent Authorization Client, Consent Authorization Server, and Consent Registry Actors.
...
The [FHIR create interaction](http://hl7.org/fhir/http.html#create) is used. See [http://hl7.org/fhir/http.html#create](http://hl7.org/fhir/http.html#create)

[Update as Create](http://hl7.org/fhir/http.html#upsert) is not required but may be supported by the actors beyond the scope of this transaction.

##### Expected Actions

The Consent Registry shall handle the create request according to policy. See the discussion in the [FHIR create interaction](http://hl7.org/fhir/http.html#create).
...
The Consent Registry has processed the [FHIR create interaction](http://hl7.org/fhir/http.html#create).

##### Message Semantics

See the [FHIR create interaction](http://hl7.org/fhir/http.html#create). The success or failure of the create interaction is indicated by the http response code (e.g. 400, 200, etc).
...
The [FHIR read interaction](http://hl7.org/fhir/http.html#read) or [FHIR vread interaction](http://hl7.org/fhir/http.html#vread) are used. See [http://hl7.org/fhir/http.html#vread](http://hl7.org/fhir/http.html#vread) and [http://hl7.org/fhir/http.html#vread](http://hl7.org/fhir/http.html#vread). The Consent Registry shall support both interactions.

##### Expected Actions

The Consent Registry shall handle the read or vread request according to policy. See the discussion in the [FHIR read interaction](http://hl7.org/fhir/http.html#read) and [http://hl7.org/fhir/http.html#vread](http://hl7.org/fhir/http.html#vread).
...
The Consent Recorder has processed the [FHIR read interaction](http://hl7.org/fhir/http.html#read) or [FHIR vread interaction](http://hl7.org/fhir/http.html#vread).

##### Message Semantics

See the [FHIR read interaction](http://hl7.org/fhir/http.html#read) and [FHIR vread interaction](http://hl7.org/fhir/http.html#vread). The success or failure of the read interaction is indicated by the http response code (e.g. 404, 200, etc).
...
The [FHIR update interaction](http://hl7.org/fhir/http.html#update) is used. See [http://hl7.org/fhir/http.html#update](http://hl7.org/fhir/http.html#update)

[Update as Create](http://hl7.org/fhir/http.html#upsert), [Conditional update](http://hl7.org/fhir/http.html#cond-update), and [Patch](http://hl7.org/fhir/http.html#patch) are not required but may be supported by the actors beyond the scope of this transaction.

##### Expected Actions

The Consent Registry shall handle the update request according to policy. See the discussion in the [FHIR update interaction](http://hl7.org/fhir/http.html#update).
...
The Consent Recorder has processed the [FHIR update interaction](http://hl7.org/fhir/http.html#update).

##### Message Semantics

See the [FHIR update interaction](http://hl7.org/fhir/http.html#update). The success or failure of the update interaction is indicated by the http response code (e.g. 400, 200, etc).
...
The [FHIR delete interaction](http://hl7.org/fhir/http.html#delete) is used. See [http://hl7.org/fhir/http.html#delete](http://hl7.org/fhir/http.html#delete)

[Conditional Delete](http://hl7.org/fhir/http.html#3.1.0.7.1) is not required but may be supported by the actors beyond the scope of this transaction.

##### Expected Actions

The Consent Registry shall handle the delete request according to policy. See the discussion in the [FHIR delete interaction](http://hl7.org/fhir/http.html#delete).
...
The Consent Recorder has processed the [FHIR delete interaction](http://hl7.org/fhir/http.html#delete).

##### Message Semantics

See the [FHIR delete interaction](http://hl7.org/fhir/http.html#delete). The success or failure of the delete interaction is indicated by the http response code (e.g. 405, 200, etc).
